...
if ($account_setup != null) {
    $this->page_label = $account_setup->agency_name; 
}
?>
<style>
    .local-wrapper {
	...
	<div id="videostream" class="col-md-6">
        ...
        <div class="local-wrapper">
            ...
            <table>
                <tr>
                    <td>
                        <img src="<?php echo $this->programURL(); ?>/images/no-stream-noise.jpg" class="stream1">
                        <img src="<?php echo $this->programURL(); ?>/images/no-stream-noise.jpg" class="stream2 hide" id="dragable">
                    </td>
                    <td><img src="<?php echo $this->programURL(); ?>/images/no-stream-noise.jpg" class="stream3 hide"></td>
                    <td><img src="<?php echo $this->programURL(); ?>/images/no-stream-noise.jpg" class="desktopshare-img hide"></td>
                </tr>
            </table>
        </div>
	</div>
            ...
            <div class="tab-content">
                <div id="appointment" class="tab-pane fade in active">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <td class="alert-info2" width="20%">Full Name:</td>
...
<script src="<?php echo $this->programURL(); ?>/js/pages/customerviewer.js?t=<?php //echo time(); ?>"></script>