    ...
    <table class="col-md-6">
    	<tbody>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form->dropDownList($model, 'code', EnumStatus::emailtemplatesdiff(), array('class'=>'text-control')); ?>
                </td>
            </tr>
            <tr>
            	<td>From: </td>
            ...
            <tr>
                <td colspan="10">
                    ...
                    <ul id="smartcodehelp" style="display:none;">
                        ...
                        <li>[agency_logo] = this append agency logo</li>
                    </ul>
                </td>
            </tr>
            <tr>
            ...
            <tr valign="top">
                <td colspan="10">
                    <?php 
                    echo $form->textArea($model, 'html_head', array('class'=>'texteditor'));
                    // $attribute = 'html_head';
            ...
            <tr valign="top">
                <td colspan="10">
                    <?php 
                    echo $form->textArea($model, 'html_body', array('class'=>'texteditor'));
                    // $attribute = 'html_body';
                    // $this->widget('ImperaviRedactorWidget',array(
                    //     'model'=>$model,
                    //     'attribute'=>$attribute,
...
<script src="<?php echo $this->programURL(); ?>/node_modules/jquery-markdown/jquery-te-1.4.0.min.js"></script>
<script>
    function saverecord(e) 
    {
        e.preventDefault();
        var param = $('#emailtemplate-form').serialize();
        $.post(global_config.base_url + '/emailtemplate/save', param, function(data) {
    ...
    !(function() {
        $(document).ready(function() {
            ...
            $('#EmailTemplate_code').on('change', function() {
                var code = $(this).val();
            ...
            $('#EmailTemplate_code').trigger('change');

            $(".texteditor").jqte({
                formats: false,
                placeholder: 'Custom Email Template Here..'
            });
