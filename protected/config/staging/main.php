...
//                 ),
    ...
    'params' => array(
        ...
        'adminEmail' => 'admin@agencythriveprogram.com',
        'noreplyEmail' => 'messages-noreply@agencythriveprogram.com',
        'adminSMTPHost' => 'appserver.engagex.com',
        'adminSMTPPort' => '465',
        'adminSMTPEmail' => 'admin@agencythriveprogram.com',
        'adminSMTPPassword' => 'Letmein12@',
        
        // Email for Checking Status
        'adminSMTPTest' => 'at-test@coverage-insight.com',
        ...
        'buildVersion' => BUILD_RELEASE . '(staging)'
    )
);
