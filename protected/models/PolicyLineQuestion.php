...
/**
 * This is the model class for table "tbl_policy_line_question".
 *
 * The followings are the available columns in table 'tbl_policy_line_question':
 * @property integer $id
 ...
 */
class PolicyLineQuestion extends CActiveRecord
{
	/**
	...
	{
		return 'tbl_policy_line_question';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('policy_parent_label, policy_child_label, policy_child_selected, cir_answer', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, assessment_guid, policy_parent_label, policy_child_label, policy_child_selected, cir_answer, account_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PolicyLineQuestion the static model class
	 */
