...
/**
 * This is the model class for table "tbl_colour_scheme".
 *
 * The followings are the available columns in table 'tbl_colour_scheme':
 * @property integer $id
 ...
 */
class ColourScheme extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('scheme_name, color_1, color_2, color_3, color_4, color_5, color_6, account_id', 'required'),
			array('account_id', 'numerical', 'integerOnly'=>true),
			array('scheme_name, color_1, color_2, color_3, color_4, color_5, color_6', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, scheme_name, color_1, color_2, color_3, color_4, color_5, color_6, account_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ColourScheme the static model class
	 */
